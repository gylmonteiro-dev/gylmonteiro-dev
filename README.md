...
- 💚 &nbsp; Conforme eu fui adquirindo experiência na área, descobri que tinha uma paixão: compartilhar meu conhecimento, e ajudar as pessoas por meio dele. Desde então, atuo como professor do eixo de Informatica em cursos técnicos do SENAC _ RN. Fico extremamente feliz quando consigo impactar uma pessoa positivamente, e, por isso, gosto tanto de fazer isso.
- 🚀 &nbsp; Atualmente, tenho como foco principal da minha carreira as áreas de desenvolvimento web. Utilizo a stack Python (Django, DRF) para desenvolver aplicações.
...
![Gyl Monteiro GitHub Stats](https://github-readme-stats.vercel.app/api?username=gylmonteiro-dev&show_icons=true&theme=dracula)
